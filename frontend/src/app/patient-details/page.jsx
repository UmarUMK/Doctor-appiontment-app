                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="Dr Sohil">
                                  Dr Sohil
                                </SelectItem>
                                <SelectItem value="Dr Shoaib">
                                  Dr Shoaib
                                </SelectItem>
                              </SelectContent>
                            </Select>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Allergies (any)</FormLabel>
                            <FormControl>
                              <Textarea
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel>
                              I acknowledge that I have reviewed and agree to
                              the privacy policy.
                            </FormLabel>
                          </div>
                        </FormItem>
